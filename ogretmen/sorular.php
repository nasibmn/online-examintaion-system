   ...
   <body>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
               ...
               <form action="" method="POST" name="question_form">
                  <div class="modal-body">
                     <div class="row">
                        <div class="input-group">
                           <span class="input-group-text bg-dark text-white">soru</span>
                     ...
                     <div class="row">
                        <div class="col">
                           <div class="input-group mt-2">
                              ...
                              <textarea name="shk1" class="form-control" aria-label="With textarea"></textarea>
                           </div>
                        </div>
                        <div class="col">
                           <div class="input-group mt-2">
                              <span class="input-group-text bg-warning text-white">2. şık</span>
                              <textarea name="shk2" class="form-control" aria-label="With textarea"></textarea>
                           </div>
                        </div>
                     </div>
                     <div class="row pt-1">
                        <div class="col">
                           <div class="input-group">
                              ...
                              <textarea  name="shk3" class="form-control" aria-label="With textarea"></textarea>
                           </div>
                        </div>
                        <div class="col">
                           <div class="input-group">
                              <span class="input-group-text bg-warning text-white">4. şık</span>
                              <textarea name="shk4" class="form-control" aria-label="With textarea"></textarea>
                           </div>
                        </div>
                     </div>
                     <input type="text" name="takeSelect" id="takeSelect">
                     <div class="input-group mt-2 mb-2">
                        <label class="input-group-text bg-success" for="inputGroupSelect01"><i class="fas fa-check-circle"></i></label>
                        <select class="form-select" name="dogru_cevap" id="inputGroupSelect01">
                  ...
                  <div class="modal-footer">
                     ...
                     <!-- <button type="button" class="btn btn-primary btn-prev">önceki</button> -->
                     <button type="submit" id="soru_kaydet" name="soru_kaydet" class="btn btn-success">Kaydet</button>
      ...
      <div class="container">
         <div class="jumbotron">
            ...
            <div class="card">
               <div class="card-body">
                     <div class="error_show w-30 text-center"></div>
                  <div class="d-flex justify-content-center pt-2">
                     <form action="" method="post" class="w-50" id="myForm">
                           <?php     $con = mysqli_connect("localhost", "root", "", "userinformation");
                               $sql = "SELECT id,ders_adi FROM subjects ORDER BY id,ders_adi";
                               $result = mysqli_query($con, $sql); ?>
                        <select name="sinavlar" id="sinavlar" class="form-select" aria-label="Default select example">
                           <option value="0" selected>Sınav listesi</option>
                        ...
                        <div class="row pt-2">
                           <div class="col">
                              <button type="submit" id="soru_sec" name="soru_sec" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#soruekle" disabled>
                              Soru Ekle
                              </button>
                           </div>
                        </div>
